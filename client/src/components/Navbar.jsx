...
//               <img src={stanvee_logo} alt="Stanvee" className="w-full h-full object-cover" />
//             </div>
//           </NavLink>

//           {/* Desktop Search */}
//           <div className="hidden md:flex items-center flex-1 max-w-2xl mx-8 text-sm gap-2 px-4 py-3 rounded-full bg-gray-50">
//             <input
...
//                 {/* Wallet */}
//                 {/* <span className="hidden md:inline-block text-sm font-medium bg-green-100 text-green-700 px-2 py-1 rounded-full">
//                   Wallet: ₹{user.walletBalance || 0} {/* ✅ Reactive wallet */}
//                 {/* </span>  */}
//                 {/* Wallet */}
//                 {/* <span className="hidden md:inline-block text-sm font-medium bg-green-100 text-green-700 px-2 py-1 rounded-full">
//               Wallet: ₹{walletBalance} {/* reacts instantly */}
//               {/* </span>  */}
//             <span className="inline-block md:inline-block text-sm font-medium bg-green-100 text-green-700 px-2 py-1 rounded-full">
...
//             {/* Dropdown */}
//             {profileOpen && (
//               <ul className="absolute right-0 top-10 bg-white border shadow-lg rounded-md w-36 text-sm z-50">
//                 <li
//                   onClick={() => {
//                     navigate("/my-account");
//                     setProfileOpen(false);
...
//           <NavLink to="/" onClick={() => setMobileMenuOpen(false)} className="block hover:text-primary">
//             Home
//           </NavLink>
//           <NavLink to="/products" onClick={() => setMobileMenuOpen(false)} className="block hover:text-primary">
//             Shop
//           </NavLink>
//           <NavLink to="/about" onClick={() => setMobileMenuOpen(false)} className="block hover:text-primary">
//             About Us
//           </NavLink>
//           <NavLink to="/contact" onClick={() => setMobileMenuOpen(false)} className="block hover:text-primary">
//             Contact Us
//           </NavLink>
//         </div>
//       )}
      ...
      <div className="bg-white sticky top-0 z-50 border-b border-gray-100">
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
          ...
          >
            ...
            <div className="w-24 sm:w-32 md:w-40 h-8 sm:h-10 md:h-12">
              <img
                src={stanvee_logo}
                alt="Stanvee"
                className="w-full h-full object-cover"
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            {/* Wallet */}
            {user && (
              <span className="inline-block md:text-sm text-xs font-medium bg-green-100 text-green-700 px-2 py-1 rounded-full">
                Wallet: ₹{walletBalance}
              </span>
            )}
            ...
            {!user ? (
              ...
              <button
                onClick={() => setShowUserLogin(true)}
                className="px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-2 bg-primary text-white rounded-full text-sm font-medium ml-2"
              >
                Login
              </button>
            ) : (
