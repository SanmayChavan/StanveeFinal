...
//     const { setShowUserLogin, setUser, axios, navigate,syncUser } = useAppContext();
...
//                 // ✅ Sync full user data to AppContext instantly
//                 await syncUser();  // <-- NEW LINE

//                 navigate('/');     // move after sync
//             } else {
//                 toast.error(data.message);
//             }
//         } catch (err) {
